...
plt.rcParams.update({
    ...
    'xtick.major.size': 6,  # Larger tick size for major ticks
    'xtick.major.width': 1.5,  # Larger tick width for major ticks
    'xtick.minor.size': 3,  # Tick size for minor ticks
    'xtick.minor.width': 1,  # Tick width for minor ticks
...
# Define the colormap
cmap = cm.get_cmap('tab20', 16)  # Get 20 distinct colors from tab20b
