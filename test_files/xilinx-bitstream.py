...
if __name__ == "__main__":
    read = io.BytesIO(open("/run/media/dcs/data2/workspaces/mopshub_board/mopshub_board.runs/impl_1/mopshub_design_32bus_wrapper.bit", "rb").read())
    ...
    # with open("mopshub_design_32bus_wrapper.bin", "wb") as f:
